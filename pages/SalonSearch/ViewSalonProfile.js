...
class ViewSalonPage extends Component{
    ...
    render(){
        ...
        let salonicon;
        if(this.state.salonInfo['salonIcon']!=undefined){
            salonicon = <Image source={this.state.icon_source} style={styles.icon} />
        } else{
            salonicon = <Image source={require('../../assets/salon_default_image.jpg')} style={styles.icon} />
        }
